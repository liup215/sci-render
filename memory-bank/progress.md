...
- BioRender-style UI reorganization v2: minimal dark top header with brand + global actions; left sidebar split into a narrow vertical drawing toolbox (grouped as Select / Shapes / Lines / Text / Draw) and a large searchable icon library; right-side Properties / Layers / Slides tabs; central canvas.
