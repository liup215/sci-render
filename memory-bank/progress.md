...
- BioRender-style UI reorganization: dark top header with brand + grouped toolbar; left sidebar with vertical drawing toolbox and tabbed Slides/Icons panels; central canvas; right-side Properties/Layers panel.
